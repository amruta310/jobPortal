<%-- 
    ...
    Created on : 14-Apr-2020, 01:10:11
    Author     : Amruta
--%>
...
<html>
	...
	<a class = "btn btn-primary" href="/JobPortalApplication/index.htm" > Job Portal</a>

	<h2>Register a New User</h2>

	<form:form action="/JobPortalApplication/user/register.htm" commandName="user"
		method="post">
