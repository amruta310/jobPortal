<%-- 
    ...
    Created on : 17-Apr-2020, 00:19:54
    Author     : Amruta
--%>
...
<a class = "btn btn-info" href="${contextPath}/jobs/search.htm" >Search Job</a>
<a class = "btn btn-info" href="${contextPath}/jobs/applied.htm" > View Applied Jobs</a>
<a class="btn btn-info" href="${contextPath}/jobs/resumeUpload.htm">Upload Resume</a>
<a id ="a1" class = "btn btn-danger" href="${contextPath}" > Logout</a>
<h1 id="td1">Welcome ${user.firstName}</h1>
...
<td id="td1">${job.company.companyName}</td>
<td id="td1"> ${job.jobName}</td>
<td id="td1"> ${job.jobDesc}</td>
<td id="td1"> ${job.postedName}</td>
<td id="td1"> ${job.postedDate}</td>
